...
import 'package:niccioli/app/pages/financeiro/boleto_detalhe_screen.dart';
...
class FinanceiroMotoristaScreen extends StatefulWidget {
  const FinanceiroMotoristaScreen({super.key});

  @override
  State<FinanceiroMotoristaScreen> createState() =>
      _FinanceiroMotoristaScreenState();
}

class _FinanceiroMotoristaScreenState
    extends State<FinanceiroMotoristaScreen> {
  String? _filtroAtivo;
